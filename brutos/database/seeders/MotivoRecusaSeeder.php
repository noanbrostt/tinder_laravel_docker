...
class MotivoRecusaSeeder extends Seeder
{
    ...
    public function run()
    {
        MotivoRecusa::upsert(
            [
                ['id_motivo_recusa' => 1, 'no_motivo_recusa' => 'Foto impropria', 'legenda' => 'Foto não pode conter conteudo explicito.'],
                ['id_motivo_recusa' => 2, 'no_motivo_recusa' => 'Descrição impropria', 'legenda' => 'Descrição não pode conter conteudo explicito.'],
